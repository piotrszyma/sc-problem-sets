...
polyFromCoefficientsModified = Poly(coefficientsModified)
rootsOfPolyFromCoefficientsModified = roots(polyFromCoefficientsModified)
...
for (index, root) = enumerate(rootsOfPolyFromCoefficientsModified)
  print(index)
  print(" & ")
  print(abs(polyval(polyFromCoefficients, root)))
  print(" & ")
  print(abs(polyval(polyFromCoefficientsModified, root)))
  print("\\\\\n")  
end
println("\\end{array}")
println("\$\$")
